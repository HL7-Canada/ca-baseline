...
The following differences are noted from the [US Core R4 PractitionerRole Profile](https://hl7.org/fhir/us/core/STU4/StructureDefinition-us-core-practitionerrole.html):
...
The invariant necessitating either code or specialty be present was removed after review against Canadian FHIR practitioner registry implementations identified challenges with some legacy systems (registry and otherwise) that have common use cases for PractitionerRole that do not include specialty or code.
